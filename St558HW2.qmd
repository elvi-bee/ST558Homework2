...
```{r}
#colnames(my_df)[2:5] try to remove weird first col
...
Create and store a list with two elements: element 1, treatment, and element 2, placebo, then name the elements of my list.
